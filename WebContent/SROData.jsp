...
<option value="Yamuna Nagar" >Yamuna Nagar</option>
                                                    ...
                                                    <td align="left" >
                                                        ...
                                                        <select name="officetype" class="txt4" id="regionName" >
<option value="All">All</option>
...
<option value="CTE" >CTE</option>
<option value="CTE/CTO" >Both CTE/CTO</option>
				...
				<table align="center" width="100%" cellpadding="0" cellspacing="0"
						class="tab-txt">
						<tr>
							<td colspan="9" align="center"><span class="headngblue"><h4 align="center">Office Type wise report of CTE</h4> </span></td>
										
									
									
										
										<div style="text-align: right">
                                                      <a href="SubRegionFileDownload">
...
<table border="1">
			 ...
			 <tr bgcolor="#CCFFCC">
				...
				<td align="center" class="headngblue" >Region</td>
				<td align="center" class="headngblue" >Office</td>
				<td align="center" class="headngblue" >Designation</td>
				<td align="center" class="headngblue" >Number Of Received Application</td>
				<td align="center" class="headngblue" >Number Of Pending Application</td>
				<td align="center" class="headngblue" >Number Of Granted Application</td>
				<td align="center" class="headngblue" >Number Of Rejected Application</td>
...
ResultSet resultSet=(ResultSet) request.getAttribute("resultSet");	//out.println(resultSet.next());
			...
			<td><%=resultSet.getInt("App_Rcvd")%></td>

			<td><%=resultSet.getInt("pend_app")%>%</td>

			<td><%=resultSet.getInt("grant_app")%></td>

			<td><%=resultSet.getInt("rej_app")%>%</td>
